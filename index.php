...
{               ?>      
        <div class="row gx-0 d-none d-lg-flex">
         ...
         <Center>
            <div class="col-st-6 text-center text-md-end">
                      
                        Designed By <a class="border-bottom" href="">Preetham, Prajwal, Philip, Keerthi, Nikitha</a>
                    </div>
</Center>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="cm[[2 0].txt" class="nav-item nav-link">Output</a>
                <a href="https://www.kaggle.com/code/preethambharadwaj/notebook27c0780788/edit" target="_blank" class="nav-item nav-link">ML</a>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Waste Management System</a>, All Right Reserved.
                    </div>
